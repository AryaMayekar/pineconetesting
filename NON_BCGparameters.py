...
def create_folder_structure(base_dir, year, month):
    ...
    folder_path = os.path.join("Data", "Non-BCG floats", base_dir, f"argo_{year}", month_name)
    os.makedirs(folder_path, exist_ok=True)
    return folder_path

def organize_existing_netcdf_files():
    """Move existing files from NETcdf_Data to organized structure"""
    old_dir = os.path.join("Data", "Non-BCG floats", "NETcdf_Data")
...
def organize_existing_excel_files():
    ...
    base_excel_folder = os.path.join("Data", "Non-BCG floats", "rough_csv_Data")
...
def convert_netcdf_to_csv():
    ...
    # Base folders
    base_nc_folder = os.path.join("Data", "Non-BCG floats", "NETcdf_Data", "argo_" + str(YEAR))
    base_excel_folder = os.path.join("Data", "Non-BCG floats", "rough_csv_Data")
...
def organize_existing_final_excel_files():
    ...
    base_final_folder = os.path.join("Data", "Non-BCG floats", "final_csv")
...
def find_csv_files_in_structure(base_folder):
    ...
    full_base_folder = os.path.join("Data", "Non-BCG floats", base_folder)
...
def create_final_csv_summaries():
    ...
    final_excel_folder = os.path.join("Data", "Non-BCG floats", "final_csv")
